 ...
 *   black-white (absolute): grayscale of the *absolute* magnitude (>= 0), which
 *     the caller has already divided by its reference scale (cross-channel std x
 *     Color SD); brightness = value^2.2.
 */
